...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-gray-900 shadow-inner mt-auto transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">
              The easiest way to find movies and book tickets at your favorite
              cinemas.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <p className="text-center text-gray-500 dark:text-gray-400">
            &copy; {currentYear} Absolute Cinema. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
